import 'dart:math';
import 'package:w1dm/Biggies_Pizza/Clientes/compras_detalles.dart';
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            SizedBox(
                                                width: 120,
                                                child: Text(documents["estado3"], textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.red[800]),)),
                                        ...
                                        SizedBox(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Container()
                                                  :
                                              Text(documents["repa"], style: TextStyle(color: Colors.red[800]), maxLines: 1, overflow: TextOverflow.fade, softWrap: false),
                                            ],
                                          ),
                                        ),
                                      ],
